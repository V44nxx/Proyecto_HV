"""
Extract Formato Único use case.

Executes structured data extraction for Colombian DAFP resumes, persists
Person, Contact, Education, WorkExperience, Language, and ExtractedField records,
and links the document to the newly created/updated person.
"""
...
class ExtractFormatoUnicoUseCase:
    """
    Coordinates DAFP Formato Único extraction, validation, and relational persistence.
    """
    ...
    def __init__(
        ...
        extractor: FormatoUnicoExtractor | None = None,
    ) -> None:
    ...
    async def execute(
        ...
        if extractions:
            for idx, e in enumerate(extractions):
                ...
                # Map page index to extraction record id
        ...
        person_model = Person(
            ...
            military_card_district=canonical_resume.person.military_card_district,
            military_card_class=canonical_resume.person.military_card_class,
        ...
        # 11. Update processing job tracking
        job = None
        if job_id:
        ...
        logger.info(
            "formato_unico_extraction_completed",
